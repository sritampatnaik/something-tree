<template>
    <transition appear name="fade">
        <div class="relative shadow-xl sm:rounded-2xl sm:overflow-hidden">
            ...
            <div class="relative px-4 pt-8 pb-16 sm:px-6 sm:pb-24 sm:pt-16 lg:pt-16 lg:pb-32 lg:px-8">
                
                <h1 class="mt-10 text-center text-3xl font-extrabold tracking-tight sm:text-4xl lg:text-5xl">
